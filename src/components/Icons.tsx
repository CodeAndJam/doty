...
export function PlayIcon() {
  return (
    <svg className="w-4 h-4" fill="#6b4e15" viewBox="0 0 24 24">
...
export function PauseIcon() {
  return (
    <svg className="w-4 h-4" fill="#c8922a" viewBox="0 0 24 24">
...
export function PinIcon({ filled }: { filled: boolean }) {
  return (
    <svg
      className="w-4 h-4"
      viewBox="0 0 24 24"
      fill={filled ? '#c8922a' : 'none'}
      stroke={filled ? '#c8922a' : '#6b4e15'}
      strokeWidth="2"
    >
...
export function SearchIcon() {
  return (
    <svg className="w-3.5 h-3.5" fill="none" stroke="#6b4e15" strokeWidth="2" viewBox="0 0 24 24">
...
export function LoopOneIcon() {
  return (
    <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M7 23l-4-4 4-4" />
      <path d="M21 13v2a4 4 0 01-4 4H3" />
      <text x="12" y="15" textAnchor="middle" fill="currentColor" stroke="none" fontSize="8" fontWeight="bold">
        1
      </text>
    </svg>
  )
